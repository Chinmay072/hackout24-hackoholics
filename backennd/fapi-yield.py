...
try:
    with open(r"C:\Life Projects\DAIICT_hackout\best_crop_yield_model.pkl", 'rb') as model_file:
        model = pickle.load(model_file)
    
    with open(r"C:\Life Projects\DAIICT_hackout\label_encoders_yield.pkl", 'rb') as encoder_file:
